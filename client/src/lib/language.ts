...
export const translations = {
  en: {
    ...
    // Technologies
    'technologies.dotnet': '.NET Framework',
    'technologies.dotnet_desc': 'C#, ASP.NET Core, Entity Framework',
    'technologies.react': 'React Ecosystem',
    'technologies.react_desc': 'React, Redux, TypeScript, Next.js',
    'technologies.flutter': 'Flutter',
    'technologies.flutter_desc': 'Dart, Flutter Widgets, State Management',
    'technologies.database': 'Database',
    'technologies.database_desc': 'SQL Server, PostgreSQL, MongoDB',
  ...
  hi: {
    ...
    // Technologies
    'technologies.dotnet': '.NET फ्रेमवर्क',
    'technologies.dotnet_desc': 'C#, ASP.NET Core, Entity Framework',
    'technologies.react': 'React इकोसिस्टम',
    'technologies.react_desc': 'React, Redux, TypeScript, Next.js',
    'technologies.flutter': 'Flutter',
    'technologies.flutter_desc': 'Dart, Flutter Widgets, State Management',
    'technologies.database': 'डेटाबेस',
    'technologies.database_desc': 'SQL Server, PostgreSQL, MongoDB',
    ...
    'checkout.payment': 'भुगतान विवरण',
    'checkout.order_summary': 'ऑर्डर सारांश',
    'checkout.complete': 'खरीदारी पूरी करें',
    
    // Profile
    'profile.purchases': 'मेरी खरीदारी',
    'profile.downloads': 'डाउनलोड',
    'profile.account': 'खाता सेटिंग्स',
  },
} as const;
